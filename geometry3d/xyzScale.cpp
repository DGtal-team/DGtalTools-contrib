...

{
  ...
  general_opt.add_options()
    ...
    ("output,o", po::value<std::string>(), "output file name of the resulting xyz point set.")
  ...
  std::vector<DGtal::Z3i::RealPoint> vPt = DGtal::PointListReader<Z3i::RealPoint>::getPointsFromFile(inputName);
  std::ofstream res;
  res.open(outputName);
  for(auto &p: vPt)
    {
