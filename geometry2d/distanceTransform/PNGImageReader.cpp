...
void PNGImageReader::startImage(size_t readBytes)
{
    ...
    _inputRow =
        (BinaryPixelType *)malloc(png_get_rowbytes(_png_ptr, _info_ptr));
...
void PNGImageReader::produceAllRows(size_t readBytes)
{
    ...
    while (_rows-- > 0)
    {
        ...
        {
            _inputRow[col] =
                _inputRow[col] > 127 ? BINARY_WHITE_PIXEL : BINARY_BLACK_PIXEL;
        }
